"""Sri Lankan Tamil regional dialect detection and curriculum-standard normalization."""
...
class DialectAgent:
    """Detect SL Tamil dialect and normalize queries toward curriculum textbook register."""
    ...
    def get_curriculum_register_guidance(self, student: StudentProfile) -> str:
        """
        Curriculum textbook register (வகுத்தல்) vs spoken variants (பிரித்தல்), optional regional
        bridging, and short 'why this divisor' hints for division ladders.
        """
        d = (getattr(student, "district", None) or "unknown").strip().lower()

        base = """
பாடத்திட்ட பதிவுருச் சொல்லாட்சி (தரம் 7, காரணிகள் பாடம்):
...
வகுத்தல் ஏணியில் ஒவ்வொரு வகுத்தலுக்கும் குறுகிய காரணம் (பாடத்திட்டம் 4.1 வகுத்தல் விதிகள்):
...
"""
        ...
        if d in ("estate", "tea_estate", "up_country", "central_estate", "plantation"):
            region = (
                ...
                "• வீட்டிலோ சமூகத்திலோ 'பிரித்தல்' என்ற சொல் அறிமுகமாக இருக்கலாம்; தேர்வு மற்றும் பாடநூலில் "
            ...
            region = (
                ...
                "• பாடத்திட்ட பதிவுருச் சொற்கள் (வகுத்தல், வகுப்போம்) மட்டுமே போதும்; கூடுதல் பேச்சுச் சொல் விளக்கம் தேவையில்லை.\n"
            )
        elif d in ("batticaloa", "east", "trincomalee"):
            region = (
                "\nமாணவர் பகுதிக் குறிப்பு:\n"
                "• முதன்மை: பாடத்திட்ட சொற்கள் (வகுத்தல், வகுப்போம்). தேவையானால் ஒரு வரியில் பேச்சுச் சொற்களை "
